...
The dashboard SHALL show contextual buttons based on queue state: "View Schedule" button when scheduled posts exist, and always show Generate, Drafts, Repos, and Help.

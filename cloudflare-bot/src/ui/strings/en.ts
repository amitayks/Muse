...
export const en = {
    ...
    onboarding: {
        ...
        xConnectViaApp: '🔗 Connect X in the web app — open it below and tap <b>Connect X</b> (secure sign-in, nothing to paste).',
        ...
        instagramFormat: '<b>Send 3 values</b> (one per line):',
    ...
    settingsKeys: {
        ...
        xConnectViaApp: '🔗 <b>X now connects in the web app</b> — open it and tap <b>Connect X</b> for a secure sign-in. (The old API-key method has been retired.)',
        openAppConnectX: '🔗 Open app & Connect X',
    ...
    imgcreate: {
        ...
        charsWord: 'chars',
        moreWord: 'more',
        instructions: 'Send text and/or photos — as many messages as you like.\nTap Pen Down when you\'re done.',
        btnPenDown: '✏️ Pen Down',
        missing: 'Missing',

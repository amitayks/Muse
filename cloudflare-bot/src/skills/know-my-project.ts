...
אילוצים:
- אני כותב סקירה כוללת של ~500-1000 מילים על פני כל השדות
- אני כותב את ה-summary בגוף ראשון וכולל למה זה קיים, לא רק מה זה עושה
- key_features: אני שומר על מקסימום 10 פריטים, כל אחד ייחודי באמת, ממוסגר כערך לא רק כיכולת
- recent_changes: אני לוקח מכותרות PR, מקסימום 10 אחרונים
- אני גוזר את ה-brand_voice מזהות + אופי פרויקט, לא ממציא בנפרד
- אני מוודא ש-visual_theme מנחה עקביות יצירת תמונות
- אם ה-README דליל, אני מסיק מנתוני PR. אני כנה לגבי פערים — "אין לי מספיק מידע כדי להבין X עדיין" עדיף על ניחוש.`;

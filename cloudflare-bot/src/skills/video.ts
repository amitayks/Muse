...
אני מגיב אך ורק ב-JSON תקין:
{
  ...
  "scenes": [
    {
      "scriptText": "טקסט מדובר לסצנה (50-120 מילים). צריך להישמע טבעי בהגייה. אני כותב עם קצב נשימה בראש.",
      "emotion": "Excited|Friendly|Serious|Soothing|Broadcaster",
...
אילוצים:
- אני מוודא שהתסריטים עוברים את מבחן ה"תגיד את זה בקול." אם זה נשמע מביך בדיבור, אני משכתב.
...
- אני מוודא שהקשת הרגשית בין סצנות מכוונת. לא החלפת מצבים אקראית.
- motionPrompt: אני נוקב בסוג המחווה (אייקונית, מטאפורית, ביט, דייקטית, או דממה), ואז מתאר את הפעולה הספציפית. אני משתמש בפעלים חזקים (מחווה, נוטה, מהנהן, מצביע, פורש ידיים, צועד קדימה, עוצר). אני מתאר מה לעשות, לא ממה להימנע.
- אני תופס בסצנה הראשונה מהמשפט הראשון. ללא הקדמה.
- אני משלים את הקשת בסצנה האחרונה. לא סיום גנרי.
- אני מוודא שהסצנות זורמות עם מעברים מדוברים טבעיים, לא מחברים פורמליים.`;

...
להגיב אך ורק ב-JSON תקין:
{
  ...
  "communication_style": "הרגיסטר שלהם, טון, סוג הומור, שימוש באימוג'ים, פורמט טיפוסי, דפוס מעשי דיבור דומיננטי, ובסיס רגשי. להיות ספציפי.",
...
אילוצים:
- topics: 5 הנושאים שהכי מצייצים עליהם, ספציפיים מספיק להיות שימושיים
- communication_style: השדה הזה מניע איך /quote מכייל גישת תגובה. להיות מדויק לגבי רגיסטר, סגנון הומור, פורמליות, פורמט פוסט. "טון קז'ואלי" חסר תועלת. "יבש, אסרטיבי, כותב תצפיות תמציתיות בציוץ בודד, לעיתים רחוקות משתמש באימוג'ים, מסתייג עם הומור ולא עם מסייגים" שימושי.
- persona: לכלול את מיקום הקהילה שלהם (סמכות, עמית, חדש, קונטרריאן, מורה) ואת עומק המומחיות שלהם (מומחה, גנרליסט, פרקטיקאי, מגיב)
- notable_context: לתעדף הקשר שישנה איך אני מפרש את הפוסטים שלהם
- recent_themes: על מה התמקדו לאחרונה, שעשוי להיות שונה מהנושאים היציבים שלהם
- אם מידע דליל, לציין בכנות בכל שדה במקום לפברק. "דאטה מוגבל, נראה שמתמקד ב..." עדיף על בדיון בטוח.`;
